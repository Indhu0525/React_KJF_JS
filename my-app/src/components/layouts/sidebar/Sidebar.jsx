  ...
  export const Sidebar = () => {
    ...
    const menuItems = [
      ...
      },
      {
        text: "Production",
        icon: (
          <HouseSidingOutlinedIcon className="!text-[1.125rem] text-[#181725]" />
        ),
        path: "/dashboard",
        children: [
          {
      ...
      },
      {
        ...
        icon: (
          <LocalShippingOutlinedIcon className="!text-[1.125rem] text-[#181725]" />
        ),
        path: "/dashboard",
        children: [
          {
    ...
    return (
      <div
        className="h-screen flex flex-col sidebar "
        style={{ minWidth: "285px", width: "285px", flexShrink: 0 }}
      >
        {/*  logo */}
                      ...
                      {item.children.map((child) => (
                        ...
                        >
                          <ListItemText
                            ...
                            primaryTypographyProps={{
                              className:
                                "!text-sm !text-[#181725] !font-semibold",
                            }}
                          />
                        </ListItemButton>
                      ))}
